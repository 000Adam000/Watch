...
public class MainWatch {
    ...
    public static void main(String[] args) {
       ...
       /* Date dt = new Date();
        ...
        Watch watch = new Watch();// object for the TimeZone
        ...
        switch (CHOICE){
            ...
            case 3:
                System.out.println(w2.gethour()+":"+w2.getminute()+":"+w2.getsecond());
                System.out.println("do you want to modify: 1-yes/2-No");
            ...
            System.out.println("Current time in Sulaimaiah: \n" + watch.getTimeZone("Asia/Baghdad"));
        }
